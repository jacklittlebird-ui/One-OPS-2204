...
import BankReconciliationPage from "./pages/accounting/BankReconciliation";
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/accounting/bank-reconciliation" element={<ProtectedRoute><AppLayout><BankReconciliationPage /></AppLayout></ProtectedRoute>} />
