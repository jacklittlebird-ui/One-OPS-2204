  ...
  general_accounts: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "VAT Return", path: "/accounting/vat-return" },
        ...
        { label: "Collections Workflow", path: "/accounting/collections" },
        ...
        { label: "Vendor Portal", path: "/accounting/vendor-portal" },
        ...
        { label: "Audit Log", path: "/accounting/audit-log" },
